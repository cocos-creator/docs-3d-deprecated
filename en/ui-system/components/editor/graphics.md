...
To use the graphics, please refer to the [graphics API](https://docs.cocos.com/creator3d/api/en/classes/ui.graphics-1.html) documentation and the [graphics](https://github.com/cocos-creator/test-cases-3d/tree/master/assets/cases/ui/14.graphics) scene of the test-cases-3d project.
