...
In addition, a node can be generated by dragging a **prefab** resource from **Resource Manager** to **Hierarchy Manager**.
You can generate a resource by dragging a **prefab** node into the **Resource Manager** through the **Hierarchy Manager**.
