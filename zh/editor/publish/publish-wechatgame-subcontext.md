# 接入微信小游戏的开放数据域
> 注意： Creator Creator 3D 不支持子域构建今后也没有计划，请使用 Cocos Creator 来构建子域，详情可以参考对应文档 [接入微信小游戏的开放数据域](https://docs.cocos.com/creator/manual/zh/publish/publish-wechatgame-sub-domain.html)，这里的文档是适当跟进但具体请参考 Cocos Creator 相关版本的对应文档。
