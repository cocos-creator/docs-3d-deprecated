...
会被捕获的日志类型以及显示颜色：
  ...
  - 日志（console.log）: <font color=#b6b6b6>灰色文字</font>，编辑器以及插件内开发者觉得有必要打印到控制台的内容。
  - 警告（console.warn）: <font color=#ebbe09>黄色文字</font>，程序运行遇到的不影响结果的异常情况。
  - 错误（console.error）: <font color=#dd3c43>红色文字</font>，运行中遇到的会影响结果的一场，必须解决的问题，或者是未被捕获的错误信息。
